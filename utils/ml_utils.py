            ...
            with conn.cursor() as cur:
                cur.execute("""
                    SELECT
                        ...
                        ps.age_years,
                        ps.gender
                    FROM workspace.healthcare_platform.patient_risk_predictions p
                    JOIN workspace.gold.gold_patient_summary ps
            ...
            with conn.cursor() as cur:
                ...
                cur.execute(f"""
                    SELECT
                        ...
                        af.severity,
                        af.detected_at
                    FROM workspace.healthcare_platform.anomaly_flags af
                    JOIN workspace.gold.gold_patient_summary ps
            ...
            with conn.cursor() as cur:
                cur.execute("""
                    SELECT
                        ...
                        training_rows,
                        trained_at
                    FROM workspace.healthcare_platform.model_metrics
